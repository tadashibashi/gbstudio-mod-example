...
LCCFLAGS = -Wl-yt0x1B -Wm-yc -Wl-j -Wm-ya4 -autobank -Wb-ext=.rel -Wb-v
...
obj/output.c: $(MOD2GBT) $(SONG)
	@mkdir -p obj
	$(MOD2GBT) $(SONG) song 1 -speed -o obj/output.c

# Build song output obj file
obj/output.o: obj/output.c
	$(LCC) $(LCCFLAGS) -c -o obj/output.o obj/output.c
...
obj/%.o: %.c
	@mkdir -p obj
	$(LCC) $(LCCFLAGS) -Ilib/gbt_player -c -o $@ $<
